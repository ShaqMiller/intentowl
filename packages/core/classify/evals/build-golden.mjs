...
const LABELS = [
  ...
  [11, 1, "pain_point", 55, 90, "Wants to find people who already have the problem - literally what IntentOwl does. Asking HOW, not which tool, so pain_point rather than buying_intent."],
  [12, 1, "pain_point", 55, 90, "SaaS beta asking what practices others used. Wants an approach, not a product recommendation, so pain_point."],
